  ...
  NSTableViewDataSource, NSTableViewDelegate, NSSearchFieldDelegate
{
  ...
  private func makeWindow() -> NSWindow {
    ...
    NSLayoutConstraint.activate([
      ...
      gainValueLabel.topAnchor.constraint(equalTo: gainSlider.bottomAnchor, constant: -4),
      ...
      gainLabel.topAnchor.constraint(equalTo: enabledSwitch.bottomAnchor, constant: 24),
      gainSlider.topAnchor.constraint(equalTo: gainLabel.bottomAnchor, constant: -4),
      peakLimiterLabel.centerXAnchor.constraint(equalTo: gainSlider.centerXAnchor),
      peakLimiterLabel.topAnchor.constraint(equalTo: gainValueLabel.bottomAnchor, constant: 28),
